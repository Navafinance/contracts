...
contract NavaNode {
    ...
    IERC20 public constant TOKEN = IERC20(0x46D741b89102815710efeA3051291E64Ff49C228);
    uint256[] public tierAllocPoints = [1 ether, 1 ether, 1 ether];
    uint256[] public tierAmounts = [200 ether, 500 ether, 5000 ether];
    struct User {
